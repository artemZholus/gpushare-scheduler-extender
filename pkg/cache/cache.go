...
import (
	...
	"github.com/artemZholus/gpushare-scheduler-extender/pkg/utils"
	"k8s.io/api/core/v1"
...
type SchedulerCache struct {
	...
	// record the knownPod, it will be added when annotation NVIDIA_GPU_ID is added, and will be removed when complete and deleted
